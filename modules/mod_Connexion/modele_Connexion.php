...
class ModeleConnexion extends Connexion {
    ...
    public function insertList($login,$sexe) {
        ...
        $req2 = self::$bdd->prepare("SELECT * FROM utilisateur, bannissement where login not like ? and sexe not like ? and utilisateur.id_Utilisateur != bannissement.id_Utilisateur_Banni");
        ...
        foreach ($req2 as $key) {
            ...
            $insertL2=self::$bdd->prepare("INSERT INTO liste VALUES (0,0,?,?)");
            $insertL2->execute(array($idU2,$idU1));
        }
        return $res2;
    }
